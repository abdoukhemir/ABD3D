...
class CompleteObjaverseDataset(IterableDataset):
    ...
    def __init__(
        ...
        self.num_workers = 0  # Always 0 — no multiprocessing
    ...
    def __iter__(self) -> Iterator:
        ...
        # Download shard — hf_hub_download returns the EXACT local path
        ...
        try:
            ...
            # Sort by view_id — whole file = ONE object
            ...
            for _ in range(num_samples):
                ...
                target_views = torch.stack([views[i]["image"] for i in target_idxs])
                depth_maps = torch.stack([views[i]["depth"] for i in [input_idx, *target_idxs]])
